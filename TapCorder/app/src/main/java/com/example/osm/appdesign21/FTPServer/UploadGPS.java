...
/**
 * Created by mh on 2016-10-10.
 */
public class UploadGPS extends AsyncTask<Void, Void, Void> {
    private String mGps;
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            generateNoteOnSD(mContext, mGps);

            FileInputStream in = new FileInputStream(new File("/storage/emulated/0/progress_recorder/gps.txt"));
            boolean result = mFTP.storeFile("gps.txt", in);
            in.close();
