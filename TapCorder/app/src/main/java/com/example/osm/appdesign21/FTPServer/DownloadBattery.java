 ...
 */
public class DownloadBattery extends AsyncTask<Void, Void, Void> {

    final static String TAG = "DownloadBattery";
    private String mfileName;
    SharedPreferences pref;

    public DownloadBattery(String pNum){
        mfileName = pNum;
    }
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            File downloadFile = new File("/storage/emulated/0/" + mfileName + "/bt.txt"); // 저장할 파일 이름(local file 형식으로 된 저장할 위치)
            ...
            try {
                ...
                ftpClient.retrieveFile("/home/pi/" + mfileName + "/bt.txt", outputStream); // 서버로부터 파일 저장(서버 파일 경로, outputStream)
